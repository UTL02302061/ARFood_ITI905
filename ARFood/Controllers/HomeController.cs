...
namespace ARFood.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            var usuario = User.Identity.GetUserName().ToString();
        ...
        public ActionResult EditarDatos()
        {
            ...
            Clientes clientes = db.Clientes.Where(x => x.IDUser == usuario).FirstOrDefault();
            
            if (clientes == null)
            {
                return RedirectToAction("Create", "Clientes",ViewBag.u);
            }
